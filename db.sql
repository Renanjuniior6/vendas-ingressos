...
CREATE TABLE IF NOT EXISTS `partners` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_partnes_user1_idx` (`user_id` ASC) VISIBLE,
  CONSTRAINT `fk_partnes_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `user_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_customers_user_idx` (`user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_events_partnes1_idx` (`partner_id` ASC) VISIBLE,
  CONSTRAINT `fk_events_partnes1`
